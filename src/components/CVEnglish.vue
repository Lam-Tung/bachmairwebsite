<template>
  <div class="divide-y-2 divide-indigo-900 p-8 lg:ml-24 lg:mr-24">
    <section class="p-4 text-lg">
      ...
      Born in 1943. Until his retirement in 2008 Professor of pedagogy, media education and media enhanced learning at the University of Kassel, Germany. Currently he is Honorary Professor at the UCL Institute of Education, University College London. From 2019 to 2021 he taught as senior professor for digital education at the Goethe University, Frankfurt, Germany. His specialisms include mass communication and education, also digital education, TV reception, cultural transformation of mass communication and media, further, media and multimodal representation for learning, mobile learning, socialization within different forms of mass communication, global learning and migration with the focus on a 2nd language, cultural transformation of education and cultural ecology. 
    </section>
    <section class="mt-4 p-4 text-lg">
      ...
      <ul class="list-disc list-inside">
        ...
        <li>
          Since 1978 until the retirement in 2008 Professor of Pedagogy, Media Education and Instructional Technology at the University Kassel
        </li>
        <li>
          Since 2019 for 2 academic years Senior Professor for Digital Education at the Goethe Universität, Frankfurt, Germany
        </li>
        <li>
          Currently Honorary Professor at the UCL Institute of Education, University College London
        </li>
      </ul>
    </section>
    <section class="mt-4 p-4 text-lg">
